 ...
 * It implements the IShape interface and provides common methods and properties for all quadrilaterals.
 */
public abstract class Quadrilateral implements IShape, Cloneable, Comparable<Quadrilateral> {
    ...
    /**
     * Constructs a Quadrilateral object with the specified side lengths, angles, and diagonals.
     *
    ...
    /**
     * Creates and returns a copy of the quadrilateral object.
     * This method is abstract and must be implemented by subclasses.
     *
     * @return a copy of the quadrilateral object
     */
    @Override
     ...
     * Returns a negative integer, zero, or a positive integer as this quadrilateral is less than, equal to, or greater than the specified quadrilateral.
     *
     * @param q the quadrilateral to be compared
     ...
     */
    @Override
    public int compareTo(Quadrilateral q) {
        if (this.calculateArea() < q.calculateArea()) {
            return -1;
        } else if (this.calculateArea() > q.calculateArea()) {
            return 1;
        } else {
            return 0;
        }
