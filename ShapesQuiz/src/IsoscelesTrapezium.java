...
public class IsoscelesTrapezium extends Trapezium {
    ...
    /**
     * Calculates and returns the area of the isosceles trapezium.
     * 
    ...
    /**
     * Creates and returns a deep copy of the isosceles trapezium object.
     * 
     * @return A deep copy of the isosceles trapezium object.
     */
