...
public class Irregular extends Quadrilateral {
     ...
     * @param angle4    the measure of the fourth angle
    ...
    /**
     * Creates and returns a new `Irregular` object that is a copy of this instance.
     *
     * @return a new `Irregular` object that is a copy of this instance
     */
